 ...
 * @author Freddy
 */
public class integral_oscuro extends javax.swing.JFrame {

    public integral_oscuro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Panel_Fondo.setBackground(new java.awt.Color(43, 43, 43));
        ...
        Panel_Fondo.add(btn_Minimizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 0, 50, 30));
        ...
        Panel_Fondo.add(btn_Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 0, 50, 30));
        ...
        Lbl_Exponente_Denominador1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Denominador_U1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Linea_Division_Variable_Sustitucion.setForeground(new java.awt.Color(0, 0, 0));
        Panel_Resultados.add(Lbl_Linea_Division_Variable_Sustitucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 80, 20));

        Lbl_Linea_Division_Integral.setBackground(new java.awt.Color(0, 0, 0));
        Lbl_Linea_Division_Integral.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Denominador_U.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Variable_Sustitucion_U.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Denominador_Resultado_Derivada.setForeground(new java.awt.Color(0, 0, 0));
        Panel_Resultados.add(Lbl_Denominador_Resultado_Derivada, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 60, 30));

        Lbl_Variable.setBackground(new java.awt.Color(0, 0, 0));
        Lbl_Variable.setForeground(new java.awt.Color(0, 0, 0));
        Panel_Resultados.add(Lbl_Variable, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, 60, 30));
        ...
        Lbl_Linea_Constante.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Panel_Resultados.add(Lbl_Linea_Constante, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 80, 20));
        ...
        Lbl_Denominador_Constante.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Panel_Resultados.add(Lbl_Denominador_Constante, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 36, 28));
        ...
        Lbl_Constante.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Linea_Fraccion2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Panel_Resultados.add(Lbl_Linea_Fraccion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 50, 10));
        ...
        Lbl_Numerador_X.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Exponente_Denominador.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lbl_Exponente_Numerador.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Combo_Box_Operaciones.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Panel_Fondo.add(btcalcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 110, 80, 40));
        ...
        Lbl_Linea_Fraccion_Opcion_3.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Btn_Siguiente_Proceso.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Panel_Fondo.add(Btn_Siguiente_Proceso, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 250, 90, 40));

        Lbl_Integral.setBackground(new java.awt.Color(255, 255, 255));
        Lbl_Integral.setFont(new java.awt.Font("Segoe UI", 0, 48)); // NOI18N
        Lbl_Integral.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Lbl_peticion_usuario.setForeground(new java.awt.Color(255, 255, 255));
        Lbl_peticion_usuario.setText("Variable a sustituir ");
        Panel_Fondo.add(Lbl_peticion_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 150, 160, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/logo de fondo integral-oscura-negro.png"))); // NOI18N
        Panel_Fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 200, 460, 350));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Panel_Fondo, javax.swing.GroupLayout.PREFERRED_SIZE, 886, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(Panel_Fondo, javax.swing.GroupLayout.PREFERRED_SIZE, 553, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(integral_oscuro.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new integral_oscuro().setVisible(true);
            }
        });
    }
